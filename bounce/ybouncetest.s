;-------------------------------------------------------------------------------
; Bouncing Square Animation - testing space
; Goal is to bounce a square around the screen by translating an (x,y) position
; into a location in screen ram. Test will begin with separate x & y direction
; movement, then explore the position mapping at the screen ram page boundary.
;
...
SCR1_RAM = $1E00 ; screen 1 page 1 ram
SCR1P1_RAM = $1E00 ; screen 1 page 1 ram
SCR1P2_RAM = $1F00 ; screen 1 page 2 ram
